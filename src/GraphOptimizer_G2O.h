...
public:
  ...
  void genEdgeData(pcl::PointCloud<pcl::PointXYZRGB>::Ptr src, pcl::PointCloud<pcl::PointXYZRGB>::Ptr tgt,Eigen::Matrix4f& relPose,Eigen::Matrix<double,6,6>& infMatrix);
